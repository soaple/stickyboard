...
import { StreamGraph } from '@stickyboard/highcharts';
...
function HighchartsStreamGraph(props) {
    const { colors } = props;

    return <StreamGraph title={'Stream Graph'} data={lineChartData} />;
}

export default HighchartsStreamGraph;
