...
create_stkbd_user_profile(user_id: Int!, name: String!, gender: Int!, company: String!, department: String!, position: String!, mobile: String!, office: String!, is_superuser: Boolean!): stkbd_user_profile
